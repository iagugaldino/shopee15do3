...
$apiUrl = 'https://api.velanipagamentos.com.br/api/v1/api-gateway/v1/transactions';

// Payload conforme documentação Velani
$payload = [
    'paymentMethod' => 'pix',
    ...
    'postbackUrl' => 'https://shopee15do3.vercel.app/api/velani-webhook'
];
...
// Extrair dados da resposta Velani (estrutura: { success, data, meta })
...
echo json_encode([
    ...
    'pix_image' => $data['pixQrCodeImage'] ?? null
]);
